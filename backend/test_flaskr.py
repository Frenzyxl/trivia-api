...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {"question": "Who was the Greek God of War?", "answer": "Ares", "category": "4",
                             "difficulty": "4"}
    ...
    def test_play_quiz(self):
        search_term = {"previous_questions": [1, 3, 14],
                       "quiz_category": {"type": "click", "id": "4"}}
        res = self.client().post("/quizzes", json=search_term)
        data = json.loads(res.data)
    ...
    def test_422_play_quiz(self):
        search_term = {"previous_questions": [2, 8, 23],
                       "quiz_category": {"id": 4}}
        res = self.client().post("/quizzes", json=search_term)
        data = json.loads(res.data)
